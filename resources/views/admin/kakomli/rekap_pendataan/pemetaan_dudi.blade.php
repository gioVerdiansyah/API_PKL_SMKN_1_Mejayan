...
@section('content')
    <title>Admin - Pemetaan DuDi</title>
    <div class="card p-4 mb-4 flex-md-row justify-content-between align-items-center">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-dot mb-0">
                    <li class="breadcrumb-item active" aria-current="page">Pemetaan data DuDi</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="card">
        <form action="{{ route('admin.rekap_pendataan.pemetaan_dudi.print') }}" method="POST">
            @csrf
            <div class="card-body pt-3 d-flex flex-column align-items-center">
                <p class="text-muted align-self-start">Cetak Pemetaan</p>
                <div class="col-md-6">
