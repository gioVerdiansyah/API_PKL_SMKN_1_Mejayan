...
@section('content')
    <title>Admin - Print Absensi Siswa PKL</title>
    ...
    <div class="card">
        <form action="{{ route('admin.siswa.print_absensi_siswa', $siswa->id) }}" method="POST">
            @csrf
            <div class="card-body pt-3 d-flex flex-column align-items-center">
                <p class="text-muted align-self-start">Cetak Absensi siswa {{ $siswa->name }}</p>
                <div class="col-md-6">
