...
@section('content')
<title>Pemetaan DuDi</title>
    <div class="card p-4 mb-4 flex-md-row justify-content-between align-items-center">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-dot mb-0">
                    <li class="breadcrumb-item active" aria-current="page">Pemetaan data DuDi {{ $jurusan }}</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="card">
        <div class="card-body pt-3">
            ...
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-center kebawah">
                <button class="download-button p-0 mx-1" onclick="window.location.href = `{{ route('rekap_pendataan.pemetaan_dudi.download') }}`">
                    <div class="docs" style="padding: 11px 20px"><svg class="css-i6dzq1" stroke-linejoin="round" stroke-linecap="round"
                        ...
                        </svg>Pemetaan_DuDi_Jurusan_{{ $jurusan }}.pdf</div>
                    <div class="download">
                ...
                <button class="print-btn" onclick="window.open('{{ route('rekap_pendataan.pemetaan_dudi.print') }}', '_blank')">
